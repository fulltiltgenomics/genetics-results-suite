...
# The one doc it owns whose SOURCE this repo cannot see: the tool-surface
...
check '^scripts/gen-doc-blocks\.py$' \
    ...
    'scripts/gen-doc-blocks.py -> docs/adding-datasets.md (the generated phenotype-join view list and the derivation it names)'
